  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Kotak Informasi / Placeholder Statistik */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
            <h3 className="text-sm text-gray-400 font-medium">Total Requests</h3>
            <p className="text-3xl font-bold mt-2 text-blue-400">Live</p>
          </div>
          <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
          ...
          <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
            ...
            <p className="text-3xl font-bold mt-2 text-purple-400">Active</p>
          </div>
        </div>

        <div className="bg-gray-800 p-6 rounded-xl border border-gray-700 text-center py-12">
          <p className="text-gray-300">
            Data analitik mendetail diproses secara aman melalui Cloudflare Pages.
          </p>
        </div>
      </div>
    </div>
